!--------------------------------------------------
!- April 8, 2020 10:49:54 PM
!- Import of : 
!- w:\vicconversions\viccpusoftwaretape\sky-ape-er 2.prg
...
535 PRINT"{clear}{black}{down*3}congratulations!!!!!!!{down} you now know what it{space*2}feels like to be on "
...
555 PRINT"{clear}{black}{down*2}i din't think you had enough courage to try{space*3}to stop a mad ape!"
560 PRINT"{down}{red}i hope you enjoyed not saving the building!"
565 FORG=1TO10000:NEXTG
570 POKE36879,27:PRINT"{clear}{blue}"
